...
export type GetBoardCandidateClaimQuery = { boardCandidateClaim: { __typename: 'BoardCandidateClaimNode', id: string, description: string, key: string, name: string, status: string, updatedAt: any } | null };
